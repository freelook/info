...
angular
    ...
    ["$rootScope", "$scope", "$route", "$location", "$routeParams", "$mdSidenav", "VK", "Google", "FB", function ($rootScope, $scope, $route, $location, $routeParams, $mdSidenav, VK, Google,FB) {
...
angular
    .module('core')
    .controller('InfoController', ["$rootScope", "$scope", function ($rootScope, $scope) {
